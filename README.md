...
If you're not ready for native ESM, top level await or latest `remark-lint` plugins, please use versions `<1`, see [#61](https://github.com/un-ts/remark-preset-prettier/issues/61) and [#97](https://github.com/remarkjs/remark-preset-prettier/pull/97) for more details.
